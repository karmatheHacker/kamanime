...
const Home = () => {
  ...
  // Debug logging for API data and errors
  useEffect(() => {
    console.log('Home.jsx API data:', data);
    if (isError) {
      console.error('Home.jsx API error:', error);
    }
  }, [data, isError, error]);
  ...
  return (
    <div className="relative">
      <Helmet>
        <title>
          Watch Anime Online, Free Anime Streaming Online on kamanime Anime
          Website
        </title>
        <meta
          name="description"
          content=" kamanime is a free no ads anime site to watch free anime. Online anime streaming at kamanime with DUB, SUB in HD kamanime.shop."
        />
        <meta property="og:title" content="home - kamanime" />
      </Helmet>
      {isLoading ? (
